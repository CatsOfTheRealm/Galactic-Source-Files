...
namespace wServer.realm.worlds
{
    public class World
    {
        ...
        public bool IsNotCombatMapArea => Id == Nexus || Id == Vault || Id == GuildHall || Id == ClothBazaar || Id == NexusExplanation ||
                                            Id == Tinker;
        public bool SafeMapArea => Name == "Nexus" || Name == "Vault" || Name == "GuildHall" || Name == "Marketplace" || Name == "Planet Selector" || Name == "Bazzar";
        ...
        {
            var announcement = string.Concat("<Public> ", msg);
            foreach (var i in Players)
