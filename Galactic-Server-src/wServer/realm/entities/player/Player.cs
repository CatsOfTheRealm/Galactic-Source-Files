...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        protected override void ExportStats(IDictionary<StatsType, object> stats)
        {
            ...
            stats[StatsType.NameChosen] = (_client.Account?.NameChosen ?? NameChosen) ? 1 : 0;
            ...
            stats[StatsType.CriticalDmg] = Stats[11];
            stats[StatsType.CriticalHit] = Stats[12];
            ...
            : base(client.Manager, client.Character.ObjectType)
        {
            ...
            var chr = _client.Character;
            HealthPots = new ItemStacker(this, 254, 0x0A22, client.Character.HealthStackCount, 3 + chr.Toolbelts);
            MagicPots = new ItemStacker(this, 255, 0x0A23, client.Character.MagicStackCount, 3 + chr.Toolbelts);
        ...
        {
            var dt = (time.ElaspedMsDelta / 1000);
        ...
        {
           var chr = _client.Character;
           if (_ToolbeltCD <= 0 && chr.Regeneration != 0)
           {
        ...
        void HandleRegen(RealmTime time)
        {
            ...
            {
                _hpRegenCounter += (Stats.GetHPRegen() + ResilienceBuff) * time.ElaspedMsDelta / 1000f;
