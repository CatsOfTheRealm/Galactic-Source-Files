...
namespace wServer.realm
{
    ...
    class Oryx
    {
        ...
        private readonly List<Tuple<string, ISetPiece>> _events = new List<Tuple<string, ISetPiece>>()
        {
            ...
            Tuple.Create("Kharanos, the Lost Dragon", (ISetPiece) new ShallowWater())
        ...
        {
            Closing = true;
            _world.Manager.Chat.Announce("The Realm is shaking... (1 min)", true);
        ...
        {
            BroadcastMsg("YOU SHALL FEEL MY WRATH!");
