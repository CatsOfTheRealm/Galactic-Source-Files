            ...
            .Init("shtrs The Forgotten King",
                new State(
                    ...
                    new State("5.6",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable, false, 1500),
                        new Shoot(20, 5, 20, projectileIndex:3, coolDown: 1000),
                        new Shoot(20, 4, 20, projectileIndex:3, coolDown: 1350)
                    )),
                    new State("6",
                        new ReturnToSpawn(1),
                    ...
                    new State("9",
                        new ConditionalEffect(ConditionEffectIndex.Invincible, false, 1000),
                        new Taunt("Do not mistake your success so far as progress."),
                        new Shoot(24, 2, 0, 3, coolDown: 1000),
                        new Shoot(24, 2, 0, 2, coolDown: 1000),
                        new Shoot(0, 8, projectileIndex: 1, fixedAngle: 0, coolDown: 10000, coolDownOffset: 1000),
                        new Shoot(0, 10, projectileIndex: 1, fixedAngle: 0, coolDown: 10000, coolDownOffset: 1500),
                        new Shoot(0, 12, projectileIndex: 1, fixedAngle: 0, coolDown: 10000, coolDownOffset: 2000),
                    ...
                    new State("11", //przez 25s 180 stopni 100 razy
                        new ConditionalEffect(ConditionEffectIndex.Invincible, false, 15000),
                        new Taunt("You're forcing my hand? Let this be a warning."),
                        ...
                        new Shoot(24, 2, 0, 3, coolDown: 500),
                        new Shoot(24, 2, 0, 2, coolDown: 500),
                        new TimedTransition(17500, "14")
                    ),
                    new State("14",
                        new HpLessTransition(0.4, "15"),
                        new Follow(0.75, 15, 3),
                        new Spawn("shtrs Royal Guardian J", 4, 0),
                        new OrderOnce(20, "shtrs Royal Guardian J", "4"),
                        new Shoot(24, 5, 15, 3, coolDown: 1000),
                        new Shoot(24, 8, 25, 3, coolDown: 1300)
                    ),
                    new State("15",
                        new ConditionalEffect(ConditionEffectIndex.Invincible, false),
                        new ReturnToSpawn(1, 0),
                    ...
                    new State("16",
                        new Shoot(24, 8, 45, 3, coolDown: 750),
                        new Shoot(0, 2, 180, 0, 100, coolDown: 750, coolDownOffset: 400, rotateAngle: 10),
                        new Shoot(0, 2, 180, 0, 95, coolDown: 750, coolDownOffset: 200, rotateAngle: 10),
                        new Shoot(0, 2, 180, 0, 90, coolDown: 750, coolDownOffset: 0, rotateAngle: 10),
                        new Shoot(0, 2, 180, 0, 85, coolDown: 750, coolDownOffset: 200, rotateAngle: 10),
                        new Shoot(0, 2, 180, 0, 80, coolDown: 750, coolDownOffset: 400, rotateAngle: 10),
                    ...
                    new State("19",
                        new RemoveConditionalEffect(ConditionEffectIndex.Invincible),
                        new Taunt(true, "My power...","But... I am limitless...", "This cannot be real..."),
                        new HpLessTransition(0.1, "20"),
