    ...
    private function onGlobalNotification(_arg1:GlobalNotification):void {
        switch (_arg1.text) {
            ...
            case "LegendaryPopupUI":
                ...
                legendarySplashText.scaleX = 1.25;
                legendarySplashText.scaleY = 1.25;
                legendarySplashText.alpha = 0.75;
                legendarySplashText.x = (legendarySplashText.width) / 2;
